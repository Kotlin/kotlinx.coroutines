 ...
 * [window.performance.now()][org.w3c.performance.Performance.now]. This function is cancellable. If the [Job] of the current coroutine is
 * completed while this suspending function is waiting, this function immediately resumes with [CancellationException].
 */
