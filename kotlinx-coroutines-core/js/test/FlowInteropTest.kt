...
class FlowInteropTest : TestBase() {
    ...
    fun testRoundTripFlowToAsyncIteratorToFlow() = runTest {
        ...
        val iterator: JsAsyncIterator<Int> = originalFlow.asDynamic()[js("Symbol.asyncIterator")]()
    ...
    fun testRoundTripAsyncIteratorToFlowToAsyncIterator() = runTest {
        ...
        val convertedIterator: JsAsyncIterator<Int> = flow.asDynamic()[js("Symbol.asyncIterator")]()
