...
import kotlin.native.concurrent.freeze as stdlibFreeze
...
private class WorkerCoroutineDispatcherImpl(name: String) : CloseableCoroutineDispatcher(), ThreadBoundInterceptor, Delay {
...
internal fun <T> T.freeze(): T {
    return if (multithreadingSupported) {
        this
    } else {
        stdlibFreeze()
    }
