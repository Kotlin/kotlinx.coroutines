...
class CoroutineDispatcherOperatorFunInvokeTest : TestBase() {
    ...
    /** Copy pasted from [WithContextTest.testThrowException], then edited to use operator. */
    @Test
    ...
    /**
     * Copy pasted from [WithContextTest.testWithContextChildWaitSameContext], then edited to use operator fun invoke for
     * [CoroutineDispatcher].
     */
    @Test
