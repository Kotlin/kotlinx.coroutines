...
internal abstract class AbstractChannel<E>(
    ...
    private class ReceiveSelect<R, E>(
        ...
        @Suppress("UNCHECKED_CAST")
        override fun completeResumeReceive(value: E) {
            startCoroutine(CoroutineStart.DEFAULT, if (receiveMode == RECEIVE_RESULT) ValueOrClosed.value(value) else value, select.completion, resumeOnCancellationFun(value), block)
        }
