...
public interface ReceiveChannel<out E> {
    ...
    /**
     * Retrieves and removes an element from this channel if it's not [empty][isEmpty], or suspends the caller while the channel is empty,
    ...
    /**
     * Retrieves and removes an element from this channel if it's not [empty][isEmpty], or suspends the caller while this channel is empty.
...
public interface Channel<E> : SendChannel<E>, ReceiveChannel<E> {
    ...
    public companion object Factory {
         ...
         * The default capacity is 16 and can be overridden by setting
