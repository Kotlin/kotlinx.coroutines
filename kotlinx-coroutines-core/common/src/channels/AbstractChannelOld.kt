 ...
 */
internal abstract class AbstractChannelOld<E> : AbstractSendChannel<E>(), Channel<E> {
    // ------ extension points for buffered channels ------
    ...
    private class Itr<E>(val channel: AbstractChannelOld<E>) : ChannelIterator<E> {
    ...
    private class ReceiveSelect<R, E>(
        @JvmField val channel: AbstractChannelOld<E>,
        @JvmField val select: SelectInstance<R>,
