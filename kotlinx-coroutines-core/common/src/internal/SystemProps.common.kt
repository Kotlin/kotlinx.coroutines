...
/**
 * Gets the system property indicated by the specified [property name][propertyName], or returns [defaultValue] if there is no property with
 * that key.
 *
...
/**
 * Gets the system property indicated by the specified [property name][propertyName], or returns [defaultValue] if there is no property with
 * that key. It also checks that the result is between [minValue] and [maxValue] (inclusively), throws [IllegalStateException] if it is not.
 *
 * **Note: this function should be used in JVM tests only, other platforms use the default value.**
 */
internal fun systemProp(
...
/**
 * Gets the system property indicated by the specified [property name][propertyName], or returns `null` if there is no property with that
 * key.
 *
 * **Note: this function should be used in JVM tests only, other platforms use the default value.**
 */
