 ...
 * - The elements of [context] and [CoroutineScope.coroutineContext] other than copyable thread-context ones are combined as is, with the
 *   elements from [context] overriding the elements from [CoroutineScope.coroutineContext] in case of equal [keys][CoroutineContext.Key].
 *
