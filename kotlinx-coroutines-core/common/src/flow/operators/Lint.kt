...
/**
 * Applying [cancellable][Flow.cancellable] to a [SharedFlow] has no effect. See the [SharedFlow] documentation on Operator Fusion.
 *
 * @suppress
 */
@Deprecated(
...
/**
 * Applying [flowOn][Flow.flowOn] to [SharedFlow] has no effect. See the [SharedFlow] documentation on Operator Fusion.
 *
 * @suppress
 */
@Deprecated(
...
/**
 * Applying [conflate][Flow.conflate] to [StateFlow] has no effect. See the [StateFlow] documentation on Operator Fusion.
 *
 * @suppress
 */
@Deprecated(
...
/**
 * Applying [distinctUntilChanged][Flow.distinctUntilChanged] to [StateFlow] has no effect. See the [StateFlow] documentation on Operator
 * Fusion.
 *
 * @suppress
 */
...
): Flow<T> = (this as Flow<T>).retry(retries, predicate)
...
@InlineOnly
public suspend inline fun <T> SharedFlow<T>.toList(): List<T> = (this as Flow<T>).toList()
...
@InlineOnly
public suspend inline fun <T> SharedFlow<T>.toSet(): Set<T> = (this as Flow<T>).toSet()
...
@InlineOnly
public suspend inline fun <T> SharedFlow<T>.count(): Int = (this as Flow<T>).count()
...
@InlineOnly
public suspend inline fun <T> SharedFlow<T>.last(): T = (this as Flow<T>).last()
