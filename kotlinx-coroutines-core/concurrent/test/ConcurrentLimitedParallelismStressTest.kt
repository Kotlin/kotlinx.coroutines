...
import ConcurrentCyclicBarrier
import kotlinx.coroutines.exceptions.yieldThread
//import kotlinx.coroutines.testing.ConcurrentCyclicBarrier
...
class LimitedParallelismStressTest1 : ConcurrentLimitedParallelismStressTest(1)
class LimitedParallelismStressTest2 : ConcurrentLimitedParallelismStressTest(2)
class LimitedParallelismStressTest3 : ConcurrentLimitedParallelismStressTest(3)
class LimitedParallelismStressTest4 : ConcurrentLimitedParallelismStressTest(4)


abstract class ConcurrentLimitedParallelismStressTest(private val targetParallelism: Int) : TestBase() {
            ...
            doStress {
                repeat(1000) {
                    ...
                    repeat(targetParallelism * 16 + 1) {
                        ...
                        try {
                            occasionallyFailing.dispatch(EmptyCoroutineContext) {
                                // do nothing.
                            }
                    ...
                    // TODO(natasha): is its getting stuck related to #4528 ?
