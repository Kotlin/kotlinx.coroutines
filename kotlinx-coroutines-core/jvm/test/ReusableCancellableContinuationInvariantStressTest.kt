...
class ReusableCancellableContinuationInvariantStressTest : TestBase() {
    ...
    @Test(timeout = 10_000) fun testExceptionFromSuspendReusable() = doTest { /* nothing */ }

    @Test(timeout = 10_000) fun testExceptionFromCancelledSuspendReusable() = doTest { it.cancel() }
