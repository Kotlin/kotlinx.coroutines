...
class WithTimeoutChildDispatchStressTest : TestBase() {
    ...
    /**
     * This stress-test makes sure that dispatching resumption from within withTimeout works appropriately (without additional dispatch)
     * despite the presence of children coroutine in a different dispatcher.
     */
    @Test
