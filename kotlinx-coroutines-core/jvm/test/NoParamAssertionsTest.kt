...
class NoParamAssertionsTest : TestBase() {
    ...
    fun testNoReceiverAssertion() {
        ...
        @Suppress("UNCHECKED_CAST") val unsafeCasted = function as ((ThreadLocal<Int>?, Int) -> ThreadContextElement<Int>)
    ...
    fun testNoParamAssertion() {
        ...
        @Suppress("UNCHECKED_CAST") val unsafeCasted = function as ((ThreadLocal<Any?>?, Any?) -> ThreadContextElement<Any>)
