...
/**
 * This class represents the data required by IDEA debugger. IDEA debugger either directly reads data from the corresponding JVM fields of
 * this class or calls the getters, so we keep both for maximal flexibility for now. **DO NOT MAKE BINARY-INCOMPATIBLE CHANGES TO THIS
 * CLASS**.
 */
@Suppress("unused")
@PublishedApi
