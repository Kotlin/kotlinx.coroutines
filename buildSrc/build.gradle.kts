...
val buildSnapshotTrain = providers.gradleProperty("build_snapshot_train").orNull?.toString()?.toBoolean() == true
...
fun version(target: String): String {
    ...
    if (target == "kotlin") {
        val snapshotVersion = providers.gradleProperty("kotlin_snapshot_version").orNull
