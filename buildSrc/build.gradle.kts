...
dependencies {
    ...
    implementation("ru.vyarus:gradle-animalsniffer-plugin:1.5.3") // Android API check implementation("ru.vyarus:gradle-animalsniffer-plugin:1.5.3") // Android API check
}
