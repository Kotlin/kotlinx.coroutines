...
/*
 * These classes are used reflectively from kotlinx-coroutines-core when this module is present in the classpath.
 * It is a substitute for service loading
 */
internal class ByteBuddyDynamicAttach : Function0<Unit> {
    override fun invoke() {
...
internal class ByteBuddyDynamicDetach : Function0<Unit> {
    override fun invoke() {
        val cl = Class.forName("kotlin.coroutines.jvm.internal.DebugProbesKt")
